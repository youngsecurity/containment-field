...
#       1. Check and pull the latest version of a container image using variables from the .env file or arguments from the CLI
...
if [ $# -gt 0 ]; then # if CLI arguments are provided
    ...
    # Pull the container
    echo ""
    echo "Info: Pulling image for container: $6..."
    echo ""
